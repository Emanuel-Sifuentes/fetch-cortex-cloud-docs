...
For more information, see Compare Agentic Assistant with Cortex Assistant.Compare Agentic Assistant with Cortex Assistant
...
You can see how the agent reaches its answer. Click the down arrow next to Plan, to view how the user input was interpreted, the planned steps, and the actions used.
...
1.  From Cortex Cloud, select Help → Submit a Support Case.
...
3.  When the issue you are opening a support case for is related to the agent, you can select the relevant endpoint. If you select the endpoint, Cortex Cloud will create and send the TSF for the agent you selected, when possible.
...
5.  If you choose to record the console, your browser may prompt you for permission for Cortex Cloud to see the contents of the tab. To allow recording, select Allow. You can now recreate the issue in your Cortex Cloud environment and all of your actions are recorded. The console recording and HAR file generation only take place within the context of the browser tab that Cortex Cloud is running in. When you are ready to stop recording, select Stop Sharing.
...
Cortex Cloud Posture Management and Cortex Cloud Runtime Security are available in multiple license configurations, either individually or as part of a bundled package. For more information on bundling options with other Cortex products, see [Cortex XSIAM product licenses](https://docs-cortex.paloaltonetworks.com/r/Cortex-XSIAM/Cortex-XSIAM-3.x-Documentation/Cortex-XSIAM-product-licenses).

| License | Configuration |
| --- | --- |
| Cloud Posture Management | Agentless comprehensive visibility across your cloud environment. Includes the following: Cloud Security Posture Management (CSPM); Cloud Infrastructure Entitlement Management (CIEM); Application Security Posture Management (ASPM); Data Security Posture Management (DSPM); Artificial Intelligence Security Posture Management (AI-SPM); Cloud Attack Surface Management (ASM); Kubernetes Security Posture Management (KSPM); CI/CD Posture Management; Agentless Workload Scanning |
| Cloud Runtime Security | Full cloud protection, detection, and response. Includes the following: Cloud Posture Management; Cloud Workload Protection (CWP); Web Application & API Security (WAAS) |
...
| Feature | Description |
| --- | --- |
| Additional Cases and Issues Retention | An additional 31-day hot storage of Case and Issue data apart from the default 186 days. Available for purchase per month for each endpoint. |
